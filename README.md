...
`fragmentation.c` is built to model fragmentation in collisions for the C version of REBOUND.  This code is currently compatible with version 4.4.10 of REBOUND and has not been tested with older or newer versions.  The image below shows the decision tree used to resolve a collision between two massive bodies.  Details may be found in [Childs & Steffen 2022 (MNRAS)](http://ui.adsabs.harvard.edu/abs/2022MNRAS.511.1848C/abstract).  An example `problem.c` file with the fragmentation code may be found above.
...
Format of output files:
 ...
 If either code is used please cite [Childs & Steffen 2022 (MNRAS)](http://ui.adsabs.harvard.edu/abs/2022MNRAS.511.1848C/abstract).
